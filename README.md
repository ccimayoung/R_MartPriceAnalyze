...
<표2. 제품별 평균 가격, 최대 가격, 최소 가격, 표준 편차> <br/>
...
<그래프6-7. 마트 별 제품 개수> <br/>

그래프6은 서울우유 흰우유(1L)를 비싸게 판매하는 상위 15개 지점, 그래프7은 삼다수를 저렴하게 판매하는 하위 15개 지점이다. 그래프에서 보이는 것처럼 프랜차이즈 별 가격 차이를 볼 수 없었다. 삼다수도 마찬가지로 프랜차이즈 별 가격 차이는 없었다. 이를 통해 프랜차이즈마다 가격이 동일하다는 가설1은 사실이 아닌 것을 알 수 있다. 연관된 가설2 또한 프랜차이즈마다 특성 제품군이 있는 것이 아니라는 것을 알게 되었다. <br/><br/>
